<?php
/**
 * Gate Fullpage Template
 * Full-page block — completely hides site content
 * Clean, minimal form centered on screen
 *
...
<div id="zask-gate-fullpage" class="zask-gate-fullpage zask-gate-<?php echo esc_attr($stage); ?>">
    <div class="zask-fp-screen">
        <div class="zask-fp-card">
            <!-- Logo / Icon -->
            <div class="zask-fp-logo">
                <?php if ($logo_url): ?>
                    <img src="<?php echo esc_url($logo_url); ?>" alt="<?php bloginfo('name'); ?>">
                <?php else: ?>
                    <div class="zask-fp-icon">🛡️</div>
                <?php endif; ?>
            </div>

            <!-- Header -->
            <div class="zask-fp-header">
                <h1><?php echo esc_html(get_option('zask_welcome_message', __('Age Verification Required', 'zask-age-gate'))); ?></h1>
                <?php $welcome_sub = get_option('zask_welcome_subtitle', ''); if ($welcome_sub): ?>
                    <p><?php echo esc_html($welcome_sub); ?></p>
                <?php endif; ?>
            </div>

            <!-- Form Area -->
            <div class="zask-fp-body">
                <?php if ($stage === 'stage1'): ?>
                    <form id="zask-stage1-form" class="zask-gate-form">
                        <?php if ($state_message): ?>
                            <div class="zask-state-notice"><?php echo esc_html($state_message); ?></div>
                        <?php endif; ?>

                        <p class="zask-fp-intro">
                            <?php
                        ...
                        <?php if (get_option('zask_require_terms') == '1'): ?>
                            <div class="zask-form-group">
                                ...
                                <div class="zask-terms-preview">
                                    <?php echo wpautop(wp_kses_post(get_option('zask_terms_text', ''))); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php $footer_text = get_option('zask_footer_text', ''); if ($footer_text): ?>
                            <p class="zask-fp-footer-text"><?php echo esc_html($footer_text); ?></p>
                        <?php endif; ?>
                    </form>
                ...
                <?php elseif ($stage === 'stage2' || $stage === 'stage3'): ?>
                    ...
                    <div id="zask-verification-form" class="zask-gate-form" style="display:none;">
                        ...
                        <button type="button" id="zask-verify-btn" class="zask-btn zask-btn-primary"><?php _e('Verify', 'zask-age-gate'); ?></button>
                        <p class="zask-form-footer">
                            <button type="button" id="zask-resend-btn" class="zask-btn-link"><?php _e('Resend Code', 'zask-age-gate'); ?></button>
                        </p>
                    </div>
                <?php endif; ?>
